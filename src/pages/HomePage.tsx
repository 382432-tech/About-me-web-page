      ...
      <section className="relative pt-8 sm:pt-14 pb-8 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-3 flex justify-center lg:justify-end">
            <div className="w-full max-w-[170px] sm:max-w-[190px] p-2 rounded-2xl bg-neutral-950 border border-neutral-800 shadow-xl space-y-2">
              <div className="relative aspect-[3/4] w-full rounded-xl overflow-hidden bg-neutral-900 border border-neutral-800 flex items-center justify-center group">
                ...
                <div 
                  ...
                  className="hidden absolute inset-0 flex-col items-center justify-center p-3 text-center bg-neutral-900"
                >
                  <UploadCloud className="w-6 h-6 text-blue-400 mb-1.5 animate-pulse" />
                  <span className="text-[11px] font-bold text-white mb-0.5">
                    Subhan's Photo
                  </span>
                  <p className="text-[9px] text-neutral-400 max-w-[140px] font-mono">
                    <span className="text-blue-400 font-semibold">profile.png</span>
                  </p>
                </div>

                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent pointer-events-none" />
                <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between pointer-events-none">
                  <span className="px-1.5 py-0.5 rounded-full bg-blue-600/80 backdrop-blur-md text-[9px] font-semibold text-white">
                    Subhan
                  </span>
                  <span className="text-[9px] font-mono text-neutral-300 bg-neutral-950/80 px-1.5 py-0.5 rounded border border-neutral-800">
                    Portrait
                  </span>
                </div>
              </div>

              <div className="py-1 px-2 rounded-lg bg-neutral-900/60 border border-neutral-800/80 text-center">
